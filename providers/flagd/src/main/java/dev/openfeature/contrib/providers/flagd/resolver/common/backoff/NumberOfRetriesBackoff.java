...
/**
 * This strategy will backoff for a fixed number of retries before being exhausted. The backoff time
 * is determined by the provided {@link BackoffStrategy}.
 */
public class NumberOfRetriesBackoff implements BackoffStrategy {
    ...
    /**
     * Creates a new backoff strategy that will backoff for a fixed number of retries before being
     * exhausted. The backoff time is determined by the provided {@link BackoffStrategy}.
     *
