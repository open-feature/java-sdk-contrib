...
public class UnleashProvider extends EventProvider {
    ...
    public void initialize(EvaluationContext evaluationContext) throws Exception {
        ...
        UnleashConfig unleashConfig =
                unleashProviderConfig.getUnleashConfigBuilder().build();
    ...
    public ProviderEvaluation<Boolean> getBooleanEvaluation(String key, Boolean defaultValue, EvaluationContext ctx) {
        ...
        return ProviderEvaluation.<Boolean>builder().value(featureBooleanValue).build();
    }
    ...
    public ProviderEvaluation<Value> getObjectEvaluation(String key, Value defaultValue, EvaluationContext ctx) {
        ...
        if (DISABLED_VARIANT.equals(evaluatedVariant)) {
            ...
            value = evaluatedVariant
                    .getPayload()
                    .map(p -> new Value(p.getValue()))
                    .orElse(null);
        }
