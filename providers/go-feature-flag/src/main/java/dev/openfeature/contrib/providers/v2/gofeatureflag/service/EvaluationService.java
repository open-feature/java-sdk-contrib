package dev.openfeature.contrib.providers.v2.gofeatureflag.service;
...
import dev.openfeature.contrib.providers.v2.gofeatureflag.util.MetadataUtil;
...
public class EvaluationService {
    ...
    public <T> ProviderEvaluation<T> getEvaluation(
        ...
        val goffResp = evaluator.evaluate(key, defaultValue, evaluationContext);
        ...
        if (flagValue.getClass() != expectedType) {
            throw new TypeMismatchError(
                    String.format("Flag value %s had unexpected type %s, expected %s.", key, flagValue.getClass(),
                            expectedType));
        }
