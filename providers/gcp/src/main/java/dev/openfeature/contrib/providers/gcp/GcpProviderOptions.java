...
@Getter
@Builder
public class GcpProviderOptions {

    /**
     * GCP project ID that owns the config. Required.
     * Example: "my-gcp-project" or numeric project number "123456789".
     */
    private final String projectId;

    /**
     * Explicit Google credentials to use when creating the GCP client.
     ...
     * secret name. For example, setting {@code namePrefix = "ff-"} maps
