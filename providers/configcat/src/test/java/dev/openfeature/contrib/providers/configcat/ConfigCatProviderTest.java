...
/**
 * ConfigCatProvider test, based on local config file evaluation. Configuration file test by
 * ConfigCat tests.
 */
@Slf4j
class ConfigCatProviderTest {
    ...
    static void setUp() {
        ...
        ConfigCatProviderConfig configCatProviderConfig = ConfigCatProviderConfig.builder()
                .sdkKey(sdkKey)
                .options(options -> options.flagOverrides(
                        OverrideDataSourceBuilder.classPathResource("features.json"), OverrideBehaviour.LOCAL_ONLY))
                .build();
    ...
    void getBooleanEvaluationByEmail() {
        ...
        assertEquals(
                true,
                configCatProvider
                        .getBooleanEvaluation(EMAIL_FLAG_NAME, false, evaluationContext)
                        .getValue());
    ...
    void getBooleanEvaluationByCountry() {
        ...
        assertEquals(
                true,
                configCatProvider
                        .getBooleanEvaluation(COUNTRY_FLAG_NAME, false, evaluationContext)
                        .getValue());
    ...
    void getIntEvaluationByUser() {
        ...
        assertEquals(
                123,
                configCatProvider
                        .getIntegerEvaluation(USERS_FLAG_NAME + "Int", 111, evaluationContext)
                        .getValue());
    ...
    void getDoubleEvaluationByUser() {
        ...
        assertEquals(
                1.23,
                configCatProvider
                        .getDoubleEvaluation(USERS_FLAG_NAME + "Double", 1.11, evaluationContext)
                        .getValue());
    ...
    void getStringEvaluationByUser() {
        ...
        assertEquals(
                "expected",
                configCatProvider
                        .getStringEvaluation(USERS_FLAG_NAME + "Str", "111", evaluationContext)
                        .getValue());
    ...
    void eventsTest() {
        ...
        configCatProvider.emitProviderConfigurationChanged(
