...
import static dev.openfeature.contrib.tools.flagd.core.TestUtils.INVALID_CFG;
import static dev.openfeature.contrib.tools.flagd.core.TestUtils.INVALID_FLAG;
import static dev.openfeature.contrib.tools.flagd.core.TestUtils.INVALID_FLAG_METADATA;
import static dev.openfeature.contrib.tools.flagd.core.TestUtils.INVALID_FLAG_MULTIPLE_ERRORS;
import static dev.openfeature.contrib.tools.flagd.core.TestUtils.INVALID_FLAG_SET_METADATA;
import static dev.openfeature.contrib.tools.flagd.core.TestUtils.VALID_FLAG_SET_METADATA;
import static dev.openfeature.contrib.tools.flagd.core.TestUtils.VALID_LONG;
import static dev.openfeature.contrib.tools.flagd.core.TestUtils.VALID_SIMPLE;
import static dev.openfeature.contrib.tools.flagd.core.TestUtils.VALID_SIMPLE_EXTRA_FIELD;
import static dev.openfeature.contrib.tools.flagd.core.TestUtils.getFlagsFromResource;
...
class FlagParserTest {
    ...
    void validJsonConfigurationWithFlagSetMetadataParsing() throws IOException {
        FlagParsingResult parsingResult = FlagParser.parseString(getFlagsFromResource(VALID_FLAG_SET_METADATA), true);
