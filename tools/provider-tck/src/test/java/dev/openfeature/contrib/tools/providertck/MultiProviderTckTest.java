...
public class MultiProviderTckTest extends ProviderTckTest {
     ...
     * {@code FLAG_NOT_FOUND}, structured values, strict numeric typing and reaching {@code READY}
     * all survive the delegation hop unchanged.
     */
    @Override
    public Set<Capability> capabilities() {
        return EnumSet.of(Capability.EVENTS, Capability.OBJECT, Capability.STRICT_NUMERIC_TYPING);
    }
}
