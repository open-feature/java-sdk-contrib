...
public interface ProviderTckHarness {
     ...
     *
     * <p>Reported in the conformance report so that a consumer can tell a design decision from a
     ...
     *
     * <p>Used to name the conformance report — {@code <dir>/<configuration>.json} and its
