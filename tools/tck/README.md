...
because a run that asks fifty of the fifty-two questions and reports success is indistinguishable, in
every artifact it produces, from one that asked all fifty-two.
